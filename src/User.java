 ...
 * Description: This class will process the different inputs
*/
...
public class User {
	 ...
	 * * user until they get this right. A future version of the program might have
	 * a sanity check to break the loop after several failed attempts and then shut
